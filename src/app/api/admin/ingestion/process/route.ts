...
export async function POST(req: NextRequest) {
  ...
  const ip = getIp(req);
  const rl = await checkRateLimitShared(`admin:ingestion:process:write:${ip}`, { maxRequests: ORAN_ADMIN_WRITE_RATE_LIMIT_MAX_REQUESTS, windowMs: RATE_LIMIT_WINDOW_MS });
