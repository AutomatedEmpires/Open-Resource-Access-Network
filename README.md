...
![Portfolio Stack](https://img.shields.io/badge/Platform-portfolio--aligned%20(Azure%20exit%20in%20progress)-0A7F5A?style=flat-square)
![PostgreSQL + PostGIS](https://img.shields.io/badge/Data-PostgreSQL%20%2B%20PostGIS-336791?style=flat-square)
![Tokenless Maps](https://img.shields.io/badge/Maps-OpenStreetMap%20(tokenless)-7EBC6F?style=flat-square)
