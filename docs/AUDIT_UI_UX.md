...
**Remaining (documented for future work):** Full focus trap (tab cycling within modal) requires refactoring to Radix Dialog wrapper. Tracked in `docs/AGENT_PROMPT_FUTURE_WORK.md`.
