...
- docs/STATUS_APEX.md: added structured APEX status report
...
- [x] docs/DEPLOYMENT_AZURE.md is reconciled with current scripts.
...
- [x] docs/STATUS_APEX.md written with the full structured report.
