 ...
 *
 * Full service detail view + decision form (approve / deny / escalate).
 * Accessed via /verify?id=<submissionId>.
            ...
            {entry.confidenceScore ? (
              <div className="space-y-4">
                ...
                <p className="text-xs text-gray-400 text-center">
                  Last computed: {formatDateTime(entry.confidenceScore.computed_at)}
                </p>
              </div>
            ) : (
          ...
          <section className="bg-white rounded-lg border border-gray-200 p-5">
            ...
            <dl className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <dd className="text-gray-800">{formatDateTime(entry.created_at)}</dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-gray-500">Last Updated</dt>
                <dd className="text-gray-800">{formatDateTime(entry.updated_at)}</dd>
              </div>
              <div className="flex justify-between">
