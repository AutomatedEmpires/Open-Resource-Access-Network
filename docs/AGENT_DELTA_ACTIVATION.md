...
- **Status output**: at the end of your session, write a complete structured status report to
  `docs/STATUS_DELTA.md` using the format defined at the bottom of this file.
...
docs/AGENTS_INGESTION_PIPELINE.md  # You update this
```
...
2. `docs/OPERATING_MODEL.md` — understand change discipline and safety guardrails
...
6. `docs/AGENTS_INGESTION_PIPELINE.md` — ingestion agent design spec
7. `docs/CONFIDENCE_SCORING.md` — confidence scoring design doc
8. `docs/SQL_AUDIT_FINDINGS.md` — existing SQL audit findings that need resolution
9. `docs/SQL_AUDIT_PLAYBOOK.md` — remediation playbook for SQL issues
10. `docs/INGESTION_AGENT_SQL_SCHEMA_MEMO.md` — schema memo for ingestion agent
...
- Identify any `.deprecated` files — document them in `docs/STATUS_DELTA.md` and confirm they
...
- Read the full pipeline code end to end. Map every step to `docs/AGENTS_INGESTION_PIPELINE.md`.
...
- Update `docs/AGENTS_INGESTION_PIPELINE.md` to match actual behavior.
...
- [ ] `docs/AGENTS_INGESTION_PIPELINE.md` accurately describes the live ingestion pipeline.
