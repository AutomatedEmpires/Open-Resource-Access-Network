      ...
      {items.map((item) => {
        ...
        return (
          <Link
            ...
            className={`inline-flex min-h-[36px] sm:min-h-[44px] items-center justify-center rounded-full px-2.5 py-1.5 text-xs sm:text-sm font-medium transition-colors sm:px-4 ${
              active
