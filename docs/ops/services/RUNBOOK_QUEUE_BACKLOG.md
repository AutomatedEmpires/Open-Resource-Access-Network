...
- Active replacement: `docs/ops/services/RUNBOOK_211_API_INGESTION.md`
- Retirement trigger: Archive after Azure Storage Queue rollback resources and credentials are decommissioned.
