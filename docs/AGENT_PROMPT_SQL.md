...
5. Authoritative docs: `docs/DATA_MODEL.md`, `docs/ROLES_PERMISSIONS.md`, `docs/SECURITY_PRIVACY.md`, `docs/SCORING_MODEL.md`.
...
Referenced in `docs/ROLES_PERMISSIONS.md` permission matrix but DOES NOT EXIST in any migration.
