...
- `docs/ROLES_PERMISSIONS.md` — Permission matrix (who can do what)
- `docs/SECURITY_PRIVACY.md` — PII rules, no raw IP in logs
- `docs/OPERATING_MODEL.md` — Update-on-touch rules
...
- `docs/UI_SURFACE_MAP.md` — update `/admins` hierarchy if UI changes
